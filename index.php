...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $db = mysqli_connect('localhost', 'uuuuuu', 'PASSSSSS', 'uuuuuu');
    if (!$db) {
...
<body>
    <div class="content">
        <div class="loginForm">
            ...
            <a href="http://u67377.kubsu-dev.ru/php_form_ivaschenko/form.php"><button>Я новый пользователь</button></a>
            <a href="http://u67377.kubsu-dev.ru/php_form_ivaschenko/admin.php"><button>Войти как администратор</button></a>
        </div>
    </div>
</body>
</html>