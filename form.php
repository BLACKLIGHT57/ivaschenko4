...
<form action="index.php" method="POST">
  <img src="star.jpg" class="imgone">
    <br /> Ваши инициалы(Фамилия имя очество):<br />
    <input name="field-fio" required placeholder="" />
  </label><br />

  <label>
    Номер телефона:<br />
    <input type="tel" name="field-phone" required placeholder="Номер телефона" />
  </label><br />
  ...
  <label>
    ...
    <br />
    <select name="field-name-11[]" multiple="multiple" required>
  ...
  <label>
    Биография:
             <br />
    <textarea name="field-biograph"></textarea>
  </label><br />
