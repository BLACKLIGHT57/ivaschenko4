...
function HTMLAnswer(massage){
      return (`
        ...
        <head>
            ...
            <link rel="stylesheet" href="http://u67377.kubsu-dev.ru/php_form_ivaschenko/style/answer.css">
        </head>
        <div class="answer">
          <p>${massage}</p>
...
function HTMLTables(results){
  ...
  return (`
        ...
        <head>
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Ответ формы</title>
            <link rel="stylesheet" href="http://u67377.kubsu-dev.ru/php_form_ivaschenko/style/tables.css">
        </head>
        <div class="answer">
            ${results.map(colum=>{
              let html =
